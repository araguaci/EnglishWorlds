<?php
    ...
    define('EI_PHP_MINIMUM_VERSION', '5.3');
    ...
    define('EI_PASSWORD_ENCRYPTION_KEY', 'password');
    ...
    // -------------------------------------------------------------------------
    // *** application name
    define('EI_APPLICATION_NAME', 'English Dz');
    // *** version number of your application
    define('EI_APPLICATION_VERSION', 'v0.1 Beta');
